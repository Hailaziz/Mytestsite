...
# SECRET_KEY = 'django-insecure-vu^5=(llux!y266mcp^8spm#&yprjbh*1g=9rz_lnbmexpi0_4'
...
ALLOWED_HOSTS = ['web-production-9240.up.railway.app', '127.0.0.1']
...
# (replace the string below with your own site URL):
CSRF_TRUSTED_ORIGINS = ['https://web-production-9240.up.railway.app']
